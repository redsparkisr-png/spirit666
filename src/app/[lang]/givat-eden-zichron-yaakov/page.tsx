...
const FAQ: Record<"en" | "he", FAQItem[]> = {
  ...
  he: [
    ...
    { q: "כמה רחוקה גבעת עדן מהמרכז ההיסטורי של זכרון יעקב?", a: "גבעת עדן ממוקמת בצד הצפוני של העיירה — נסיעה ולא הליכה מהמושבה והמדרחוב ברוב הרחובות. קונים שרוצים מרחק הליכה נוח למרכז מדי יום עשויים להעדיף שכונה מרכזית יותר." },
  ],
};
