...
const FAQ: Record<"en" | "he", FAQItem[]> = {
  ...
  he: [
    { q: "האם אפשר להגיע ברגל מהשמורה לכל מקום בזכרון יעקב?", a: "השמורה נמצאת בדרך כלל במרחק הליכה ממרכז מסחרי מקומי עם שירותי יום-יום כמו סופרמרקט, בתי קפה ובית כנסת, אך מרחק ההליכה המדויק תלוי ברחוב הספציפי." },
