...
const FAQ_HE = [
  ...
  },
  {
    ...
    a: "כן. נכסים בזכרון יעקב נהנים מפרמיה של ⁦15–25%⁩ לעומת נכסים דומים בבנימינה, המשקפת את האופי ההיסטורי, הקהילה האנגלופונית המבוססת, מגוון השירותים הגדול יותר, והבנייה החדשה המוגבלת. בנימינה מציעה פיתוחים חדשים יותר וקרבה גדולה יותר לתחנת הרכבת.",
  },
  {
...
const PRICE_TABLE_HE = [
  ...
  { type: "דירת 4 חד' / דירת גן", range: "⁦2.8 – 4.0⁩ מיליון ₪", sqm: "⁦25,000–30,000⁩ ₪/מ\"ר", notes: "דירות גן נהנות מפרמיה" },
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 p-5 bg-muted/30 rounded-xl border border-border">
              ...
              <ul className="space-y-1 text-xs font-body text-muted-foreground">
                ...
                <li>
                  {isHe
                    ? "• פלטפורמות נדל\"ן ישראליות: יד2, מדלן, גרין-אקרס (מודעות שנצפו ⁦2024–2025⁩)"
                    : "• Israeli real estate platforms: Yad2, Madlan, Green-Acres (observed listings 2024–2025)"}
                </li>
                <li>
                  {isHe
