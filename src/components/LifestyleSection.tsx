...
const images = [
  { src: lifestyle1, alt: "Vineyard sunset in Zichron Yaakov" },
  { src: lifestyle2, alt: "Charming stone street with flowers" },
  { src: lifestyle3, alt: "Mediterranean sea view from hilltop" },
  { src: lifestyle4, alt: "Morning coffee at a village cafe" },
  { src: lifestyle5, alt: "Lavender garden path in residential neighborhood" },
  { src: lifestyle6, alt: "Sunset over Mediterranean coastline" },
];
