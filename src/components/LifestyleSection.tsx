          ...
          <ul className={`max-w-xl mx-auto text-muted-foreground font-body text-sm space-y-3 ${isHe ? "text-right" : "text-left"}`}>
            {(isHe
              ? [
                  ...
                  { title: "חינוך איכותי", desc: "משפחות רבות בוחרות לעבור לזכרון בזכות מערכת החינוך החזקה והסביבה המשפחתית במושבה." },
                  { title: "המדרחוב ההיסטורי", desc: "בתי האבן, היקבים, הגלריות והמסעדות לאורך המדרחוב יוצרים מרכז חיים ייחודי." },
                  { title: "קהילה ואוכלוסייה איכותית", desc: "זכרון מושכת אליה משפחות שמחפשות איכות חיים וסביבה מצוינת לגדל בה ילדים." },
