...
export function useSiteContent() {
  ...
  const localFallbacks: Record<string, Record<string, string>> = {
    ...
    "home.trust_line.item_2": { en: "288+ Families", he: "מעל 288 משפחות" },
    ...
    "moving.section_4_body": { en: "We don't only sell homes — we hand-hold the whole move: search, negotiation, legal coordination, and post-move acclimation. Local knowledge is the difference.", he: "אנחנו לא רק מוכרים בתים — מלווים את כל המעבר: חיפוש, משא ומתן, תיאום משפטי והיקלטות אחרי המעבר. הידע המקומי עושה את ההבדל." },
